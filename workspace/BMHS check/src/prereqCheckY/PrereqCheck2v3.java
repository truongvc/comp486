...
public class PrereqCheck2v3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			reader = new CSVReader(new FileReader("comTechASN.csv"));
...
//	    	 }
	    	 ...
	    	 asn = Integer.parseInt(students.get(runNum)[0]);
	    	 runNum++;
	    	 System.out.println();
...
//				 System.out.println("module: " + (values.get(i)[3])); //debug - print all codes for matching record
				 if(//!values.get(i)[6].equals("") && 
					 ...
					 String format = "|%1$-15s|%2$-20s|%3$-10s|%4$-35s|%5$-10s|\n";//string formatting
